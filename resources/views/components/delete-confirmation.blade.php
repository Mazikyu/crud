...
{{-- <el-dialog> --}}
<dialog id="delete-confirmation" aria-labelledby="dialog-title"
    ...
    <div tabindex="0"
        ...
        <el-dialog-panel
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 id="dialog-title" class="text-base font-semibold text-gray-900">Deleting Post</h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Are you sure you want to delete your post? All
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button id="delete_confirm" type="submit" command="close" commandfor="dialog"
                    class="delete_confirm inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 sm:ml-3 sm:w-auto">Delete</button>
                <button id="delete_cancel" type="button" command="close" commandfor="dialog"
                    class="delete_cancel mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
            </div>
        </el-dialog-panel>
    </div>
</dialog>
